...
vc_map( array(
	...
	'base' => 'vc_carousel',
	//webnus// 'content_element' => false,
	//webnus// 'deprecated' => '4.4',
	'class' => '',
	...
	'params' => array(
		...
		array(
			'type' => 'sorted_list',
			'heading' => __( 'Teaser layout <span style="color: #FF932E;">Note: Only "Link to post" option works, " No link" and "Link to bigger image" are deprecated.</span>', 'js_composer' ),
			'param_name' => 'layout',
			'description' => __( 'Control teasers look. Enable blocks and place them in desired order. Note: This setting can be overrriden on post to post basis.', 'js_composer' ),
			'value' => 'title,image,text',
			'options' => array(
