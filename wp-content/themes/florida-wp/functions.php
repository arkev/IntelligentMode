...
function webnus_script_loader(){
    ...
    wp_enqueue_style( 'gfont-style', "$protocol://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700|Roboto+Slab:300,400,700" );
...
function webnus_footer_script_loader(){
    ...
    wp_enqueue_script(
            'custom_script', get_template_directory_uri() . '/js/florida-custom.js', array( 'jquery' ), null, true
    );
