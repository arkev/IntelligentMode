...
?><div class="<?php echo ( 3 == $topbar_leftcontent )? 'socialfollow' : 'top-links'; ?> lftflot"><?php
 ...
 switch($topbar_leftcontent)
 {
	...
	case 2:
	?>
	<h6><i class="fa-envelope-o"></i> <?php echo '<a href='.$webnus_options->webnus_header_email().'>'.$webnus_options->webnus_header_email().'</a>'; ?></h6> <h6><i class="fa-phone"></i> <?php echo $webnus_options->webnus_header_phone();?></h6>
	<?php
	break;
	case 3:
